...
<div class="row rem">
<div class="col-4">
<h3><a href="#hotels"><span style="color:#fdd835">  <i class="far fa-building"></i></span>Hotels</a></h3>
</div>
<div class="col-4">
<h3><a href="#notes"> <span style="color:#fdd835"><i class="far fa-edit"></i></span>Notes</a></h3>
</div>
<div class="col-4">
<h3><a href="#policy"><span style="color:#fdd835"> <i class="far fa-bookmark"></i></span>Policy</a></h3>
</div>
</div> --}}
{{-- <hr>
<div class="itt">
...
{{-- <div id="hotels">
<h3><span style="color:#fdd835">  <i class="far fa-building"></i></span> Hotels</h3>
</div> --}}
{{-- </div>
</div>
</div> --}}
...
Hotel will be provided 4-5 minutes walk from Haram, in Ajyad Al Sud.</p>
<p><strong>Overview:</strong>
Located at Ajyad Al Sud, next to Le Meridian Makkah, near Haram.</p>
<p><strong>Accommodation: </strong>
Hotel offers elegantly furnished room as per standard laid by Ministry Of Haj, Saudi Arabia.</p>
<p><strong>Restaurants:</strong>
Main restaurants located at M / S floor, providing wide range of Indian Food.</p>
<p><strong>Services & facilities:</strong>
Mini fridge and hair dryers, Wi–Fi High Speed Internet,
Safe Box available in the room.</p>
</div>
</div>
</div>
<div class="row">
...
<p> <strong>Hotel Name: </strong>
Hotel will be provided 250 Meters away from Masjid Al Nabawi in Central Area.</p>
<p><strong>Accommodation: </strong>
Hotel offers elegantly furnished room as per standard laid by Ministry Of Haj, Saudi Arabia.</p>
<p><strong>Restaurants:</strong>
Main restaurants located at M / S floor, providing wide range of Indian Food. </p>
...
<h2>Package does not Includes <i class="fas fa-angle-down"></i></h2>
</a>
</h5>
</div>
<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
<div class="card-block">
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>Tour operator is not responsible for loss of valuable items or Money</p>
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>No refund of unused services or lesser duration of stay for any reasons</p>
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>Extra luggage charges other than mentioned on ticket will be paid by the pilgrim</p>
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>Person/s traveling individually other than group date, will bear the additional transportation charges as per their itinerary</p>
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>If Pilgrim decides to change in travel dates for any reasons, other than the group dates, the Air tickets / cancellation charges will paid by Hajis.</p>
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>Wheel-Chair Purchase & Handling.</p>
<p><span style="color:#fdd835"><i class="fas fa-caret-right"></i></span>Qurbani cost is not included in the Haj Package, Haji has to pay the cost by himself, however we will arrange the Qurbani on behalf of the group on individual requests on receipt of money.</p>                                  </div>
</div>
</div> --}}
{{-- <div class="card">
